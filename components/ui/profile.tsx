...
import MyImage from '@/public/assets/images/me/gradpic.jpg'

export default function Profile() {
    return(
        <div className="flex items-center gap-x-2 transition-colors duration-75 text-primary-foreground mt-[-75px]">
            {/*Photo*/}
            ...
            {/*Name*/}
            <div className="text-3xl font-medium">Trenton Butler</div>
        </div>
    )
}
